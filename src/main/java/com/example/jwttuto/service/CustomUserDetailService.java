...
public class CustomUserDetailService implements UserDetailsService {
    ...
    public CustomUserDetailService(User1Repository user1Repository) {
    ...
    private org.springframework.security.core.userdetails.User createUser(String username, User1 user) {
        if (!user.isActivated()) {
